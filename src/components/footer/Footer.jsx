    ...
    <footer>
        <div class="footer-center">
            <div class="footer-top">
                <p class="hero-primary-title">"Architecture is inhabited sculpture."</p>
                <a href="#email" class="footer-contact-us-btn">
                    Contact Us
                </a>
            </div>
            ...
            <div class="footer-bottom">
                        ...
                        <div class="footer-social-medias">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#facebook">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                            <path d="M14.002 9.3V12.2H16.602C16.802 12.2 16.902 12.4 16.902 12.6L16.502 14.5C16.502 14.6 16.302 14.7 16.202 14.7H14.002V22H11.002V14.8H9.30195C9.10195 14.8 9.00195 14.7 9.00195 14.5V12.6C9.00195 12.4 9.10195 12.3 9.30195 12.3H11.002V9C11.002 7.3 12.302 6 14.002 6H16.702C16.902 6 17.002 6.1 17.002 6.3V8.7C17.002 8.9 16.902 9 16.702 9H14.302C14.102 9 14.002 9.1 14.002 9.3V9.3Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
                                            <path d="M15.002 22H9.00195C4.00195 22 2.00195 20 2.00195 15V9C2.00195 4 4.00195 2 9.00195 2H15.002C20.002 2 22.002 4 22.002 9V15C22.002 20 20.002 22 15.002 22Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <p>Facebook</p>
                                    </a>
                                </li>
                                <li>
                                    <a href="#youtube">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                            <path d="M17.002 20H7.00195C4.00195 20 2.00195 18 2.00195 15V9C2.00195 6 4.00195 4 7.00195 4H17.002C20.002 4 22.002 6 22.002 9V15C22.002 18 20.002 20 17.002 20Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M11.4016 9.5003L13.9016 11.0003C14.8016 11.6003 14.8016 12.5003 13.9016 13.1003L11.4016 14.6003C10.4016 15.2003 9.60156 14.7003 9.60156 13.6003V10.6003C9.60156 9.3003 10.4016 8.9003 11.4016 9.5003Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <p>YouTube</p>
                                    </a>
                                </li>
                ...
                <div class="copyright-text">© 2022 TourVillage. All rights reserved.</div>
            </div>
        </div>
    </footer>
  )
